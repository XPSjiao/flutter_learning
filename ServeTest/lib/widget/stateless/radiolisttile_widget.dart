...
class RadioListTileWidget extends StatefulWidget {
  ...
  @override
  State<RadioListTileWidget> createState() => RadioListTileWidgetState();
}

class RadioListTileWidgetState extends State<RadioListTileWidget> {
  final Map<ItemType, ItemBean> languages = {
    ItemType.java: ItemBean('Java', '世界上最流行的语言', '/images/java.webp'),
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text(
                  'Flutter提供的一个通用列表组件条目结构，为左中结构，尾部是一个Radio。相应位置可插入组件，可以很方便地应对特定条目。',
                  style: descStyle,
                ),
              ),
              Container(
