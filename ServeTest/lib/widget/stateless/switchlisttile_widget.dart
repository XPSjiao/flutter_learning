          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text(
                  'flutter提供的一个通用列表条目结构，为左中结构，尾部是一个Switch。相应位置可以插入组件，可以很方便地应对特定的条目。',
                  style: descStyle,
                ),
              ),
              Container(
                ...
                child: SwitchListTile(
                  ...
                  activeThumbImage: const AssetImage('images/header.jpg'),
                  inactiveThumbImage: const AssetImage('images/header.jpg'),
